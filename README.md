...
Close Watch cycles through a shuffled set of six cats, showing each once before reshuffling. The lounging cat rests on the first card, blinks, and occasionally twitches its ear.
